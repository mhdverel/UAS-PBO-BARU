...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if (!jRadioButton1.isSelected() && !jRadioButton2.isSelected() && !jRadioButton3.isSelected()) {
            JOptionPane.showMessageDialog(rootPane, "Silahkan Pilih Menu");
        }
        

            try {
                int input_pembayaran = Integer.valueOf(jTextField16.getText());
                
                if (input_pembayaran < 0) {
                    JOptionPane.showMessageDialog(rootPane, "Tidak Boleh Negatif");
                    jTextField16.setText("");
                }else{
                    int hasil = input_pembayaran - Integer.valueOf(jTextField13.getText());
                
                    if (hasil < 0) {
                        JOptionPane.showMessageDialog(rootPane, "Uang kurang Rp. " + hasil);
                        jTextField16.setText("");
                    }else if (hasil > 0){
                        JOptionPane.showMessageDialog(rootPane, "Uang kembalian Rp. " + hasil);
                        clear();
                    }else{
                        JOptionPane.showMessageDialog(rootPane, "Terimakasih");
                        clear();
                    }
                }
                ...
                JOptionPane.showMessageDialog(rootPane, "Silahkan Masukkan Nominal Pembayaran");
                jTextField16.setText("");        
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        //handling exception pertama untuk memilih menu dulu
        if (!jRadioButton1.isSelected() && !jRadioButton2.isSelected() && !jRadioButton3.isSelected()) {
            JOptionPane.showMessageDialog(rootPane, "Silahkan Pilih Menu");
        }
        ...
        try {
            item1 = Integer.valueOf(jTextField1.getText()) * Integer.valueOf(jTextField4.getText());
            item2 = Integer.valueOf(jTextField2.getText()) * Integer.valueOf(jTextField5.getText());
            item3 = Integer.valueOf(jTextField3.getText()) * Integer.valueOf(jTextField6.getText());
            
            if (item1<0 || item2<0 || item3<0) {
                JOptionPane.showMessageDialog(rootPane, "Input Tidak Boleh Negatif");
                clear();
            }
        } catch (NumberFormatException e){
            JOptionPane.showMessageDialog(rootPane, "Input harus berupa angka");
            clear();
        } catch(Exception e){
            JOptionPane.showMessageDialog(rootPane, "Input tidak valid");
            clear();
        }
        ...
        try {
            ...
            if (Integer.valueOf(jTextField5.getText()) > 50) {
                ...
                jTextField11.setText(String.valueOf(total2 - Integer.valueOf(jTextField8.getText())));
            }else{
            ...
            if (Integer.valueOf(jTextField6.getText()) > 50) {
                ...
                jTextField12.setText(String.valueOf(total3 - Integer.valueOf(jTextField9 .getText())));
            }else{
        ...
        // hitung total bayar
        int total_bayar = Integer.valueOf(jTextField10.getText()) + Integer.valueOf(jTextField11.getText()) + Integer.valueOf(jTextField12.getText());
        jTextField14.setText(String.valueOf(total_bayar));
        
        // diskon jika > 1jt
        int diskon_total = 0;
        if (Integer.valueOf(jTextField14.getText()) > 1000000) {
            diskon_total = total_bayar * 5/100;
            jTextField15.setText(String.valueOf(diskon_total));
        }else{
            jTextField15.setText("0");
        }
        
        // hasil dikurangi diskon
        int setelah_diskon = 0;
        setelah_diskon = total_bayar - diskon_total;
        jTextField13.setText(String.valueOf(setelah_diskon));
        
        // enable form
        if (Integer.valueOf(jTextField13.getText()) > 0) {
